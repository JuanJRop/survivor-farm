...
namespace SurvivorFarm.Runtime.Gameplay
{
    ...
    public sealed class ResourceTier : MonoBehaviour
    {
        ...
        public bool CanHarvest(PlayerInventory player)
        {
            ...
            if(!ready)FarmNotificationCenter.Show($"Recurso Nv.{Tier} · desbloquea y compra {PlayerToolbelt.GetDisplayName(Tool)} Nv.{Tier} en K.");
            return ready;
        }
        public void Grant(PlayerInventory player)
        {
